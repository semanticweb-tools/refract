...
An atomic action that adds, modifies, or removes an annotation on an ontology element using an existing annotation property. Annotations are ignored by reasoners and do not affect the structure or semantic meaning of the ontology. To add or delete an annotation property, see [Structural Action](StructuralAction.md).
